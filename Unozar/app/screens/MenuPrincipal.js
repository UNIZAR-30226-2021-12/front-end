...
export default class MenuPrincipal extends Component {
  constructor(props) {
    ...
    this.items = [
      ...
      },
      {
        ...
        command: () => {
          this.setState({ show1: false }), this.props.navigation.push("Inicio");
        },
      },
    ];
  }
  ...
  deleteUser = () => {
    ...
    fetch(
      `https://unozar.herokuapp.com/player/deletePlayer/`,
      requestOptions
      ...
      <>
              ...
              <View style={styles.containerButtonBuscar}>
                <View style={styles.buttonBuscar}>
                  <Button
                    ...
                    onPress={() =>
                      this.setState({ show2: !this.state.show2, show3: false })
                    }
                  />
                </View>
                {this.state.show2 && (
                      ...
                      {this.state.show3 && (
                        <>
                          <View style={styles.containtertextBots}>
                            <Text style={styles.textBots}>
                              {" "}
                              ¿Cuantos bots quieres añadir?{" "}
                            </Text>
        ...
        <View style={styles.menu}>
          <div>
            ...
            {this.state.show1 && <Menu model={this.items} />}
          </div>
        </View>
